...
/**
 * "Single-Entry Module Library" as JDev calls it. For example a single Jar file with sources Jar.
 *
 * @since 1.0-milestone-5
 */
public interface JDevSingleEntryLibraryDependency extends JDevDependency, ExternalDependency {
    /**
